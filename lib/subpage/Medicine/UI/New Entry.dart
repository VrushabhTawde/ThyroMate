                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (dosageController!.text != "") {
                        dosage = num.parse(dosageController!.text);
                      }
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xFF1CC8A5),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? Color(0xFF1CC8A5) : Colors.white,
            ),
            child: Center(
              child: Padding(
          ...
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xFF1CC8A5) : Colors.transparent,
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: Color(0xFF1CC8A5)),
          ),
        ]),
      ),
    );
